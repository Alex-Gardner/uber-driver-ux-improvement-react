...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"images/no-nav-no-loading.svg":[function(require,module,exports) {
module.exports = "/no-nav-no-loading.53a10ede.svg";
},{}],"stage1.js":[function(require,module,exports) {
'use strict';
...
var _noNavNoLoading = require('./images/no-nav-no-loading.svg');

var _noNavNoLoading2 = _interopRequireDefault(_noNavNoLoading);
...
function Stage1() {
    return _react2.default.createElement(
        'figure',
        null,
        _react2.default.createElement('img', { src: _noNavNoLoading2.default })
    );
}
},{"react":"node_modules/react/index.js","./images/no-nav-no-loading.svg":"images/no-nav-no-loading.svg"}],"images/settings-hamburger.svg":[function(require,module,exports) {
module.exports = "/settings-hamburger.54a5fdef.svg";
},{}],"images/fakemap-with-path.svg":[function(require,module,exports) {
module.exports = "/fakemap-with-path.d6366b0e.svg";
...
},{"_css_loader":"../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"phone-container.js":[function(require,module,exports) {
'use strict';
...
var _settingsHamburger = require('./images/settings-hamburger.svg');

var _settingsHamburger2 = _interopRequireDefault(_settingsHamburger);

var _fakemapWithPath = require('./images/fakemap-with-path.svg');

var _fakemapWithPath2 = _interopRequireDefault(_fakemapWithPath);
...
var mockAddress = '123 Elm Circle';

function AddressDiv(props) {
    return props.isLoading ? null : _react2.default.createElement(
        'div',
...
function DestinationAddress(props) {
    return props.isLoading ? _react2.default.createElement(
        'h2',
        { className: 'trip-type' },
        'Routing...'
...
function Outline(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'top-panel-holder' },
            _react2.default.createElement(
                'div',
                { className: props.isNavigating ? 'top-panel with-nav' : 'top-panel' },
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: 'bottom-panel-client-name' },
                _react2.default.createElement(
                    'h4',
                    null,
                    '-*Client Name*-'
            ...
            props.isNavigating ? null : _react2.default.createElement(
                'div',
                { className: 'trip-complete-container' },
                _react2.default.createElement(
                    'div',
                    { className: 'trip-complete' },
                    'COMPLETE TRIP'
                )
            )
        )
...
},{"react":"node_modules/react/index.js","./images/settings-hamburger.svg":"images/settings-hamburger.svg","./images/fakemap-with-path.svg":"images/fakemap-with-path.svg","./main.css":"main.css"}],"index.js":[function(require,module,exports) {
'use strict';
...
var _stage = require('./stage1.js');

var _stage2 = _interopRequireDefault(_stage);

var _phoneContainer = require('./phone-container.js');
...
var AppShell = function (_React$Component) {
    ...
    function AppShell(props) {
        ...
        _this.handleNavStatusToggle = _this.handleNavStatusToggle.bind(_this);
        _this.handleLoadingStatusToggle = _this.handleLoadingStatusToggle.bind(_this);
        _this.state = {
            isLoading: true,
            isNavigating: false
        };
    ...
    _createClass(AppShell, [{
        key: 'handleNavStatusToggle',
        value: function handleNavStatusToggle() {
            this.setState({
        ...
        key: 'handleLoadingStatusToggle',
        value: function handleLoadingStatusToggle() {
            this.setState({
                isLoading: !this.state.isLoading,
                isNavigating: this.state.isNavigating
            });
...
//# sourceMappingURL=/uber-driver-ux.671c3fba.map